...
1. Clone this repository to your local machine:
   ...
   ```bash
   git clone https://github.com/Kccendana/catalog_of_my_things.git
   ```
...
Feel free to check the [issues page](https://github.com/Kccendana/catalog_of_my_things/issues).
